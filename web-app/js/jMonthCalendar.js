			...
			jQuery.each(calendarEvents, function(){
				...
				for (var i = istart; i <= iend; i++) {
					...
					var toManyEvents = (startBoxCompare == 0 || (i == 0 && startBoxCompare == -1) || 
										continueEvent || (startBoxCompare == -1 && endBoxCompare >= 0)) && b.vOffset >= (b.getCellBox().height() - 12); //todo: find height of boxes or more link.
					
					//alert("b.vOffset: " + b.vOffset + ", cell height: " + (b.getCellBox().height() - b.getLabelHeight() - 32));
					//alert(continueEvent);
//					alert(toManyEvents);
					
					if (startBoxCompare == 0 || (i == 0 && startBoxCompare == -1) || continueEvent) {
