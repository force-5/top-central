<div class="clearfix" style="padding-bottom: 10px;">
  <div id="boxbor_left">Affidavits<br/>
    <input size="10" type="file" onchange="addSelectedFile(this);"/>
  </div>
    ...
    <ul>
      <g:each in="${workerCertification.affidavits}" var="affidavit">
        <li>
          ...
          <span>${affidavit.fileName}</span>
          <g:hiddenField name="existingAffidavitIds" value="${affidavit.id}"/>
        </li>
      </g:each>
    </ul>
