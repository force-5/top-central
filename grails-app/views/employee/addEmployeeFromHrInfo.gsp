...
<div id="right-panel">
    <g:form controller="employee" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="${worker?.id}"/>
        <div id="right-top">
            <g:render template="/employee/addEmployee" model="[worker:worker]"/>
        </div>

        <div id="submit-button">
            <g:actionSubmit class="button" action="createEmployeeFromHrInfo" value="Add"/>&nbsp;
        </div>
