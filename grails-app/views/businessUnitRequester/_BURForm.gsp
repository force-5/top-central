    ...
    <table>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="unit">Business Units&nbsp;<span class="asterisk">*</span></label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: instance, field: 'unit', 'errors')}">
                <g:select name="unit" class="${hasErrors(bean: instance, field: 'unit', 'errors ')} listbox"
                        value="${instance.unit}" style="width:140px;" id="unit" from="${BusinessUnit.list()*.name}"/>
            </td>
        </tr>
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value ${hasErrors(bean: instance, field: 'firstName', 'errors')}">
                <g:if test="${ConfigurationHolder?.config?.isEmployeeEditable == 'true'}">
                    <input type="text" id="firstName" name="firstName" value="${fieldValue(bean: instance, field: 'firstName')}"/>
                </g:if>
                <g:else>
                    <input type="text" id="firstName" name="firstName" class="readOnlyField" value="${fieldValue(bean: instance, field: 'firstName')}" readonly="true"/>
                </g:else>
            </td>
        </tr>
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value ${hasErrors(bean: instance, field: 'middleName', 'errors')}">
                <g:if test="${ConfigurationHolder?.config?.isEmployeeEditable == 'true'}">
                    <input type="text" id="middleName" name="middleName" value="${fieldValue(bean: instance, field: 'middleName')}"/>
                </g:if>
                <g:else>
                    <input type="text" id="middleName" name="middleName" class="readOnlyField" value="${fieldValue(bean: instance, field: 'middleName')}" readonly="true"/>
                </g:else>
            </td>
        </tr>
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value ${hasErrors(bean: instance, field: 'lastName', 'errors')}">
                <g:if test="${ConfigurationHolder?.config?.isEmployeeEditable == 'true'}">
                    <input type="text" id="lastName" name="lastName" value="${fieldValue(bean: instance, field: 'lastName')}"/>
                </g:if>
                <g:else>
                    <input type="text" id="lastName" name="lastName" class="readOnlyField" value="${fieldValue(bean: instance, field: 'lastName')}" readonly="true"/>
                </g:else>
            </td>
        </tr>
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value ${hasErrors(bean: instance, field: 'phone', 'errors')}">
                ...
                <g:else>
                    <input type="text" id="phone" name="phone" class="readOnlyField" value="${fieldValue(bean: instance, field: 'phone')}" readonly="true"/>
                </g:else>
            </td>
        </tr>
        ...
        %{--<input type="text" id="email" name="email" value="${fieldValue(bean: instance, field: 'email')}"/>--}%
        %{--</td>--}%
        %{--</tr>--}%
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value ${hasErrors(bean: instance, field: 'slid', 'errors')}">
                <g:if test="${fail == 'true'}">
                    <input type="text" id="slid" name="slid" value="${fieldValue(bean: instance, field: 'slid')}" readonly="true"/>
                </g:if>
                <g:else>
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value ${hasErrors(bean: instance, field: 'notes', 'errors')}">
                <textarea name="notes" cols="" class="area" style="width:237px; height:50px; " rows="3">${fieldValue(bean: instance, field: 'notes')}</textarea>
            </td>
        </tr>
