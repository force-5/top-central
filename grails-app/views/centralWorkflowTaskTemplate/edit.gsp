...
<div class="body">
<h1>Edit Central Workflow Task Template</h1>
...
<g:hiddenField name="version" value="${centralWorkflowTaskTemplateInstance?.version}"/>
...
<tr class="prop">
    ...
    <td valign="top"
        ...
        <g:textField name="templateName"
                     value="${centralWorkflowTaskTemplateInstance.id}" style="width:600px;color: #808080;background-color:#f2f2f2;" readonly="true"/>
    </td>
</tr>
...
<tr class="prop">
    ...
    <td valign="top"
        ...
        <g:textField name="responseForm" value="${centralWorkflowTaskTemplateInstance?.responseForm}"
                     style="width:290px;color: #808080;background-color:#f2f2f2;" readonly="true"/><br/>
...
<tr class="prop">
    ...
    <td valign="top"
        ...
        <g:select border="1px;" name="workflowTaskType" from="${CentralWorkflowTaskType?.values()}"
                  noSelection="['':'(Select One)']" value="${centralWorkflowTaskTemplateInstance?.workflowTaskType}"
                  style="width:300px;color: #808080;background-color:#f2f2f2;" class="listbox" disabled="true"/>
    </td>
</tr>
...
<tr class="prop">
    ...
    <td valign="top"
        ...
        <g:select name="actions" from="${['APPROVE', 'REJECT', 'CONFIRM']}" multiple="yes" size="3"
                  value="${centralWorkflowTaskTemplateInstance?.actions}" style="width:300px;border: 1px solid #000;color: #808080;background-color:#f2f2f2;" disabled="true"/>
    </td>
</tr>
%{----}%
<tr class="prop">
...
<tr class="prop">
    ...
    <td valign="top"
        ...
        <g:select name="escalationTemplate.id"
                  ...
                  value="${centralWorkflowTaskTemplateInstance?.escalationTemplate?.id}"
                  class="listbox" style="width: 610px;"/>
    </td>
</tr>
